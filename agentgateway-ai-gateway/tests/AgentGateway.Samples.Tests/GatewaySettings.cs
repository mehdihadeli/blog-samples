...
public sealed class GatewayEndpoints
{
    ...
    public string LlmUrl { get; set; } = "http://localhost:5000/v1";
    public string A2AUrl { get; set; } = "http://localhost:5000/a2a";
    public string AdminUrl { get; set; } = "http://localhost:5000/admin";
    public string MetricsUrl { get; set; } = "http://localhost:5000/metrics";
}
