...
using DotNet7CustomizeProblemDetails.Core.ProblemDetail;
using DotNet7CustomizeProblemDetails.Core.ProblemDetail.Middlewares.CaptureExceptionMiddleware;
using DotNet7CustomizeProblemDetails.Weather;
using Humanizer;
...
builder.Services.AddProblemDetails(problemDetailsOptions =>
{
    ...
    problemDetailsOptions.CustomizeProblemDetails = problemDetailContext =>
    {
        ...
        {
            var problemDetailMapper =
                problemDetailContext.HttpContext.RequestServices.GetRequiredService<IProblemDetailMapper>();

            var (mappedStatusCode, title) = problemDetailMapper.GetMappedStatusCodes(
            ...
            PopulateNewProblemDetail(
                ...
                problemDetailContext.HttpContext,
                mappedStatusCode,
                exceptionFeature.Error
            );
            problemDetailContext.HttpContext.Response.StatusCode = mappedStatusCode;
        }

        static void PopulateNewProblemDetail(
        ...
        )
        {
            ...
            existingProblemDetails.Extensions.TryAdd(
                "traceId",
